...
# Tests that are consistently flaky on my machines, in alphabetical order
...
TEST_TARGET="${TEST_TARGET} -//tensorflow/python/data/experimental/kernel_tests/serialization:checkpoint_input_pipeline_hook_test"
